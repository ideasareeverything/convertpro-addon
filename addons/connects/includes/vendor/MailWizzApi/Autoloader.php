 ...
 * Yii::registerAutoloader(array('CPRO_MailWizzApi_Autoloader', 'autoloader'), true);
 * </pre>
 * 
 ...
 * @since 1.0
 */
class CPRO_MailWizzApi_Autoloader
{
    /**
    ...
    /**
     * Registers the CPRO_MailWizzApi_Autoloader::autoloader()
     */
    public static function register()
    {
        spl_autoload_register(array('CPRO_MailWizzApi_Autoloader', 'autoloader'));
    }
}