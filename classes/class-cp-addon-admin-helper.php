 ...
 * @author      Convert Pro Addon
 * @copyright   Copyright (c) 2017, Convert Pro Addon
 * @since       Convert Pro Addon 1.0
 */

if ( ! class_exists( 'CP_Addon_Admin_Helper' ) ) :

	/**
	 * Admin Helper
	 */
	final class CP_Addon_Admin_Helper {
